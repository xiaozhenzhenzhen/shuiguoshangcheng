...
Page({
  ...
  bindGetUserInfo: function (e) {    // 点击 授权按钮
    if (e.detail.userInfo) {  //用户按了允许授权按钮
      var that = this;
      console.log(e.detail.userInfo); // 获取到用户的信息了
      wx.showLoading({
        title: '加载中',
        mask: true
      })
              ...
              wx.login({
                success: res => {
                  ...
                  wx.request({
                    ...
                    url: 'https://api.weixin.qq.com/sns/jscode2session?appid=wxc36777d7cab7d59c&secret=b0af4b6d9543acbef68bb1d36302aa02&js_code=' + res.code + '&grant_type=authorization_code',
                    success: res => {
                      // 获取到用户的 openid
